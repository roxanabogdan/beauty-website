...
import botoxImage from '../images/slide1.png';
import syringe from '../images/slide2.png';

export const Carousel = () => {
    const [currentIndex, setCurrentIndex] = useState(0);
    const images = [botoxImage, syringe]; // Array of images
    ...
    return (
        <div id="default-carousel" className="relative w-full" data-carousel="slide">
            <div className="relative h-[600px] overflow-hidden rounded-lg xs:h-56 sm:h-[400px] md:h-[600px]">
